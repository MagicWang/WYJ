...
namespace WYJ.Core.Themes
{
    public static class ResourceKeys
    {
        ...
        public static readonly ComponentResourceKey ButtonNormalForegroundKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonNormalForegroundKey");
        ...
        public static readonly ComponentResourceKey ButtonMouseOverForegroundKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonMouseOverForegroundKey");
        ...
        public static readonly ComponentResourceKey ButtonPressedForegroundKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonPressedForegroundKey");
        ...
        public static readonly ComponentResourceKey ButtonFocusedForegroundKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonFocusedForegroundKey");
        ...
        public static readonly ComponentResourceKey ButtonDisabledBackgroundKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonDisabledBackgroundKey");
        public static readonly ComponentResourceKey ButtonDisabledForegroundKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonDisabledForegroundKey");
        ...
        public static readonly ComponentResourceKey ButtonDisabledInnerBorderKey = new ComponentResourceKey(typeof(ResourceKeys), "ButtonDisabledInnerBorderKey");
